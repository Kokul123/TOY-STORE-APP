                ...
                <div className="account-container">    
                    <div className="account-info">
                        <div className="info-row">
                            ...
                            <button className="info-value">FantasyToyLand</button>
                            <div>
                        ...
                        <div className="info-row">
                            ...
                            <button className="info-value" onClick={() => handleRedirect('https://www.twitter.com')}>FantasyToyLand</button>
                            <div>
                        ...
                        <div className="info-row">
                            ...
                            <button className="info-value" onClick={() => handleRedirect('https://www.instagram.com')}>FantasyToyLand</button>
                            <div>
                        ...
                        <div className="info-row">
                            ...
                            <button onClick={() => handleRedirect('https://www.linkedin.com')} className="info-value">FantasyToyLand</button>
